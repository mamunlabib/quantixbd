...
const PRODUCTS = [
  ...
  {slug:"hoco-smart-finder",  emoji:"📡", name:"Hoco E101 Smart Finder",                        short:"Dual anti-lost GPS tracker supporting both Apple Find My & Android Find Hub", category:"electronics", image:"https://i.postimg.cc/Kv2JmYyh/hoco-cat.png", salePrice:"৳790", originalPrice:"৳1,500", savings:"৳710", tagline:"Best price in Bangladesh — guaranteed!"},
  {slug:"travel-neck-pillow", emoji:"😴", name:"Travel Neck Pillow",                             short:"Manual press auto-inflatable travel neck pillow for ultimate comfort on the go", category:"lifestyle", image:"https://i.postimg.cc/mrYvjGxx/main-neck-pillow.jpg", salePrice:"৳349", originalPrice:"৳499", savings:"৳150", tagline:"Best price in Bangladesh — guaranteed!"},
  {slug:"foldable-sports-water-bottle", emoji:"🍶", name:"Foldable Sports Water Bottle",          short:"Collapsible silicone water bottle with fun sports ball design. Leakproof, foldable, and perfect for kids at school, gym, or outdoor adventures.", category:"home", image:"https://i.postimg.cc/Sx4KFvHp/Gemini-Generated-Image-piuv2gpiuv2gpiuv.png", salePrice:"৳449", originalPrice:"৳500", savings:"৳51", tagline:"Best price in Bangladesh — guaranteed!"}
];
  ...
  const priceBlock = p.salePrice
    ? `
        <div class="product-price-sale">
          ...
          <p class="price-tagline">${escAttr(p.tagline)}</p>
        </div>`
